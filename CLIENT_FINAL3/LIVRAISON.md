...
- **Maintenance mensuelle** : basculement manuel des souscripteurs `Spécial` vers le mois choisi via l'interface, empêchant les créations automatiques non désirées
