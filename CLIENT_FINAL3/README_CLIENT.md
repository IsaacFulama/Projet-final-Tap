...
- Basculement manuel des souscripteurs `Spécial` vers le mois choisi via l'interface, empêchant les créations automatiques non désirées
- Répartition automatique des versements `Spécial` sur le plus ancien mois impayé, puis sur les mois suivants
- Cette répartition fonctionne pour un nouvel enregistrement comme pour un paiement complémentaire
